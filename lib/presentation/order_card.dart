                ...
                children: [
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Row(
                        crossAxisAlignment:
                            order.deliveryStatus[index]['partner'] == null ||
                              ...
                              children: [
                                Text(
                                  ...
                                  style: Theme.of(context)
                                      ...
                                      .bodyMedium
                                      ?.copyWith(
                                          decoration: order.status[index] > 2
                                ...
                                order.deliveryStatus[index]['partner'] ==
                                    ...
                                    : Opacity(
                                        opacity: 0.5,
                                        child: Text(
                                          "${order.deliveryStatus[index]['partner']}, ${order.deliveryStatus[index]['text']}",
                                          style: Theme.of(context)
                                              .textTheme
                                              .bodyMedium
                                              ?.copyWith(
